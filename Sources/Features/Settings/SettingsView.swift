...
struct SettingsView: View {
    ...
    @AppStorage(AppConstants.remoteCanvasEnabledKey) private var remoteEnabled = false
    @AppStorage(AppConstants.remoteCanvasURLKey) private var remoteURL = ""
    @AppStorage(AppConstants.remoteCanvasTokenKey) private var remoteToken = ""
    ...
    private func applyRemoteToggle(_ enabled: Bool) {
        if enabled {
            ...
            UserDefaults.standard.set(true, forKey: AppConstants.remoteCanvasEnabledKey)
            providerManager.enableRemoteProvider(url: url, token: remoteToken)
        } else {
            UserDefaults.standard.set(false, forKey: AppConstants.remoteCanvasEnabledKey)
